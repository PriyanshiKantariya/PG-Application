      ...
      <div className="relative max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-md">
          ...
          <button
            ...
            className="w-full py-3 bg-white border border-gray-300 text-[#424242] font-semibold rounded-lg hover:bg-gray-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm flex items-center justify-center gap-3"
          >
            {googleLoading ? (
              <span className="flex items-center justify-center">
                <LoadingSpinner size="small" className="mr-2" />
