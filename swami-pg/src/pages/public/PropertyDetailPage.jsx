    ...
    <div className="bg-[#F5F5F5] min-h-screen">
      ...
      <div className="fixed bottom-0 left-0 right-0 lg:hidden bg-white/95 backdrop-blur-md border-t border-gray-200 p-3 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] z-50">
        <div className="max-w-lg mx-auto flex gap-2.5">
          <a
            href={getCallLink('7575866048')}
            className="flex-1 flex items-center justify-center gap-1.5 px-4 py-3 bg-white border border-gray-200 rounded-xl font-medium text-[#1a1a1a] shadow-sm"
          >
            <Icons.Phone className="w-4 h-4 text-[#5B9BD5]" />
            Call Us
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 flex items-center justify-center gap-1.5 px-4 py-3 bg-[#25D366] text-white rounded-xl font-medium shadow-sm"
          >
            <Icons.WhatsApp className="w-4 h-4" />
            WhatsApp
          </a>
